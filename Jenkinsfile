...
// for display purposes
      ...
      //git 'https://github.com/raknas999/hello-world-servlet.git'
         git https://github.com/ArchanaaDevops/hello-world-servlet.git
...
post {
        success {
            mail to:"archanadevops2022@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"archanadevops2022@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
